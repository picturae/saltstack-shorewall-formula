...
{{ datamap.shorewall.config.interfaces.path }}:
  file:
    ...
    - mode: {{ datamap.shorewall.config.interfaces.mode|default('644') }}
...
{{ datamap.shorewall.config.policy.path }}:
  file:
    ...
    - mode: {{ datamap.shorewall.config.policy.mode|default('644') }}
...
{{ datamap.shorewall.config.shorewall_default.path }}:
  file:
    ...
    - mode: {{ datamap.shorewall.config.shorewall_default.mode|default('644') }}
...
{{ datamap.shorewall.config.shorewall_conf.fpath }}:
  file:
    ...
    - mode: {{ datamap.shorewall.config.shorewall_conf.mode|default('644') }}
...
{{ datamap.shorewall.config.zones.path }}:
  file:
    ...
    - mode: {{ datamap.shorewall.config.zones.mode|default('644') }}
